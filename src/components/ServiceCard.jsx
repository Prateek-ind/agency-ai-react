...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    ...
    >
      <div
        className={`pointer-events-none blur-2xl p-[1px]" : "p-[1px] bg-transparent" rounded-full bg-gradient-to-r
      ...
      >
        <div className="bg-gray-100 dark:bg-gray-700  rounded-full">
          <img
            src={service.icon}
            alt=""
            className="max-w-24 bg-white dark:bg-gray-900 border-8
             border-gray-100 dark:border-gray-700 rounded-full m-2"
          />
        </div>
